...
Bios::Bios(const Type type) :
	_type{ type }
{}

bool Bios::isGB() const { return _type == Type::GameBoy; }
bool Bios::isGBC() const { return _type == Type::GameBoyColor; }

u8 Bios::operator[] (const Address addr) const
{
	switch (_type)
	{
		default:
		case Type::GameBoy:
			return GB_BIOS_BYTES[addr % 256];
		case Type::GameBoyColor:
			return GBC_BIOS_BYTES[addr % 2048];
	}
}


Bios Bios::gameBoyBios() { return Type::GameBoy; }
Bios Bios::gameBoyColorBios() { return Type::GameBoyColor; }


const u8 Bios::GB_BIOS_BYTES[256] {
...
const u8 Bios::GBC_BIOS_BYTES[2048] {
